...
### テレビ視聴率分析サービスの番組組み合わせシミュレーション機能（最適解、近似解）の開発

### テレビ視聴率分析サービスのバッチ機能リプレイス

### 物流システム顧客連携基盤（EDI）のDR環境構築及びセキュリティ通信機能の開発

### 物流システムモバイル端末連携基盤用インターフェースシステム（EAI）の構築

### 人事評価管理サービスの企画及びPOC

### インバウンドビジネスサービスのモバイルバックエンド構築及びモバイルアプリの開発

### YouTuber向けマッチング及び分析プラットフォームの構築
